...
const DaisyNav = () => {
    ...
    return (
        <div className="navbar fixed z-10 max-w-[1316px] mx-auto font-messina justify-between bg-[#F3F3F3] bg-opacity-30">
            <img src={logo} alt="" />
            <div className="gap-5">
                <div className="space-x-2 sm:block hidden">
                    <button className="p-4 rounded-full border border-solid text-white hover:duration-500 border-[#D9D9D9] hover:border-[#AFCD80] hover:bg-[#AFCD80]"><IoShareSocialOutline /></button>
                    <button className="p-4 text-white font-messina font-light rounded-full border border-solid hover:duration-500 border-[#D9D9D9] hover:border-[#2042B6] hover:bg-[#2042B6]">Download the 2024 Report</button>
                </div>
